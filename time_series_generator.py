...
file_names = [f for f in listdir(base_dir)]
...
for i, fn in enumerate(file_names):
    pcap_stats_file = open(base_dir + fn, "r")
...
dataframe.to_csv('./time_series_df.csv', index = False) 

###################
# Timeseries plot #
###################

x_values = np.array([(i + 5) for i in range(60)])
